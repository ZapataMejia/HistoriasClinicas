...
Salud Élite Pereira SAS supports the full range of Markdown syntax in `.md` files as well as frontmatter YAML to define metadata such as a tilte and description. 

## Frontmatter

You can modify individual pages in Salud Élite Pereira SAS by setting values in their fromtmatter. Frontmetter is set at the top of your files between `---` separators.
...
Images in Salud Élite Pereira SAS use [Astro's built-in optimized asset support](https://docs.astro.build/en/guides/images/).
...
### How to structure page content in Salud Élite Pereira SAS

Salud Élite Pereira SAS is configured to automatically use your page title as a top-level heading and will include an “Overview” heading at top of each page's table of contents. We recommend starting each page with regular paragraph text content and using on-page headings from `<h2>` and down:

```md
---
title: Markdown Guide
description: How to use Markdown in Salud Élite Pereira SAS
---

This page describes how to use Markdown in Salud Élite Pereira SAS.
...
description: How to use Salud Élite Pereira SAS's built-in anchor links
---
...
Salud Élite Pereira SAS supports all other Markdown authoring syntax, such as lists and tables. See the [Markdown Cheat Sheet from The Markdown Guide](https://www.markdownguide.org/cheat-sheet/) for a quick overview of all the Markdown syntax elements.