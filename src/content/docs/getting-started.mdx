...
To create your own documentation site using Salud Élite Pereira SAS, follow these steps:
- Visit the [Salud Élite Pereira SAS GitHub](https://github.com/HYP3R00T/Salud Élite Pereira SAS) repository.
- Click on the "Use this template" button.
- Follow the prompts to create a new repository using this template.

<Callout variant="info">
Try Salud Élite Pereira SAS in your browser: [open the template on StackBlitz](https://stackblitz.com/github/HYP3R00T/Salud Élite Pereira SAS)
</Callout>
...
Salud Élite Pereira SAS is built to be highly customizable. You can start editing the markdown files in the content folder to create your own documentation pages.
